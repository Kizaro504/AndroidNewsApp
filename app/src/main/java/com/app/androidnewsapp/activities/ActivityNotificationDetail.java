...
import com.app.androidnewsapp.utils.NativeTemplateStyle;
import com.app.androidnewsapp.utils.NetworkCheck;
import com.app.androidnewsapp.utils.TemplateView;
...
public class ActivityNotificationDetail extends AppCompatActivity {
    ...
    public void initAds() {
        if (AdsConfig.BANNER_AD_ON_NEWS_DETAIL || AdsConfig.INTERSTITIAL_AD_ON_CLICK_VIDEO) {
    ...
    private void loadInterstitialAd() {
        if (AdsConfig.INTERSTITIAL_ON_NEWS_LIST) {
            ...
            interstitialAd.setAdListener(new AdListener() {
                @Override
                public void onAdClosed() {
                    interstitialAd.loadAd(Tools.getAdRequest(ActivityNotificationDetail.this));
                }
            });
        }
    }
